...
*/
(function(){
var path = "http://qn-image.zhongyingtougu.com/emoji/",  //项目所在的根地址
emojis = {
	"wechat" : {
		"name" : "微信表情",
		"col" : 10,
		"path" : path,
		"enable" : true,
		"sources" : ["微笑.png","撇嘴.png","色.png","发呆.png","得意.png","流泪.png","害羞.png","闭嘴.png","睡.png","大哭.png","尴尬.png","发怒.png","调皮.png","呲牙.png","惊讶.png","难过.png","囧.png","抓狂.png","吐.png","偷笑.png",

  "愉快.png","白眼.png","傲慢.png","困.png","惊恐.png","流汗.png","憨笑.png","悠闲.png","奋斗.png","咒骂.png","疑问.png","嘘.png","晕.png","衰.png","骷髅.png","敲打.png","再见.png","擦汗.png","抠鼻.png","鼓掌.png",

  "坏笑.png","左哼哼.png","右哼哼.png","哈欠.png","鄙视.png","委屈.png","快哭了.png","阴险.png","亲亲.png","可怜.png","菜刀.png","西瓜.png","啤酒.png","咖啡.png","猪头.png","玫瑰.png","凋谢.png","嘴唇.png","爱心.png","心碎.png",

  "蛋糕.png","炸弹.png","便便.png","月亮.png","太阳.png","拥抱.png","强.png","弱.png","握手.png","胜利.png","抱拳.png","勾引.png","拳头.png","OK.png","跳跳.png","发抖.png","怄火.png","转圈.png","高兴.png","口罩.png",

  "笑哭.png","吐舌头.png","傻呆.png","恐惧.png","悲伤.png","不屑.png","嘿哈.png","捂脸.png","奸笑.png","机智.png","皱眉.png","耶.png","鬼脸.png","合十.png","加油.png","庆祝.png","礼物.png","红包.png","鸡.png"
					]
	}
};
...
wantEmoji.prototype = {
	...
	__createPageList : function(){
		...
		for( var i = 1; i <= pageNum; i++ ){
			...
			temp += '<li class="wEmoji-page-list" data-pageIdx="'+i+'">•</li>';
		}
